...
import {
    GetQuestionResponse, GetQuestionsResponse, IQuestion,
    PostQuestionPayload, PostQuestionResponse
} from '$common/types';
...
export const getQuestions = async (req: Request, res: Response) => {
    ...
    try {
        const questions: IQuestion[] = await db.question.find({});
...
export const getQuestion = async (req: Request, res: Response) => {
    ...
    try {
        const question: IQuestion = await db.question.findById(_id);
        if (!question)
...
export const postQuestion = async (req: Request, res: Response) => {
    ...
    try {
        ...
        await db.user.updatOne({_id: userID}, {$push: {questions: question}});
